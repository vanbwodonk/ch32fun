/*
 * Example for using bit-bang I2C (via extralibs/static_i2c.h) with 128x32 graphic OLED
 */

#define SSD1306_128X64
#define SSD1306_I2C_SDA PA6
#define SSD1306_I2C_SCL PA5
#define SSD1306_RST_PIN PC0

#include "ch32fun.h"
#include <stdio.h>
#include "ssd1306_i2c_static.h"
#include "ssd1306.h"
#include "bomb.h"
...
int main()
{
	...
	Delay_Ms( 100 );
	printf("\r\r\n\ni2c_oled_static example\n\r");

	Delay_Ms( 100 );
	printf("initializing static-i2c oled...");
	if(!ssd1306_i2c_init())
	{
		ssd1306_init();
		printf("done.\n\r");
